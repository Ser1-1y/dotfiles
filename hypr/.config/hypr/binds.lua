...
local mainMod = "SUPER"
local modes = {"power-saver", "balanced", "performance"}
local i = 1
...
hl.bind(mainMod .. " + ALT + W", hl.dsp.focus({ direction = "up" }))
hl.bind(mainMod .. " + ALT + S", hl.dsp.focus({ direction = "down" }))
...
hl.bind(mainMod .. " + B", function()
    ...
    local next_mode = modes[current_mode_index]

    hl.dispatch(
        hl.dsp.exec_cmd("powerprofilesctl set " .. next_mode)
    )
end, { repeating = true })
